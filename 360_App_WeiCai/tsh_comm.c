   ...
   while ((data_temp = TlvPacket_ReadBody(&decodePkt, &tag, &length)))
   {
       ...
       case EN_TSH_FIELD_INFORM_CURRVIEWINGANGLE:
       {
           ...
           stViewingMode_t* vm = (stViewingMode_t*)data_temp;
			...
			DBG("tsh back function CurrViewMode=%d\n",CurrViewMode);	
            break;
       }
       ...
       case EN_TSH_FIELD_INFORM_CALIRESULT:
       {
		   ...
		   uint32_t camera_cali_status = 0;
           printf("camera_status ==> %d\n", camera_status);
           //avmCalibrationPara.caliFlag = 1;
           switch (camera_status)
           {
           case CALI_ERR_0:
            camera_cali_status = CAMERA_CALI_NONE; 
                break;
           case CALI_ERR_17:
           case CALI_ERR_33:
           case CALI_ERR_49:
           case CALI_ERR_65:
            camera_cali_status = CAMERA_CALI_F; 
               break;
           case CALI_ERR_18:
           case CALI_ERR_34:
           case CALI_ERR_50:
           case CALI_ERR_66:
            camera_cali_status = CAMERA_CALI_B; 
               break;
           case CALI_ERR_19:
           case CALI_ERR_35:
           case CALI_ERR_51:
           case CALI_ERR_67:
            camera_cali_status = CAMERA_CALI_L; 
               break;
           case CALI_ERR_20:
           case CALI_ERR_36:
           case CALI_ERR_52:
           case CALI_ERR_68:
            camera_cali_status = CAMERA_CALI_R; 
               break;
            default:
		   ...
		   msg.MsgData = camera_cali_status;
       ...
       case EN_TSH_FIELD_INFORM_CAMERAS_STATE:
            if(length != (uint16_t)sizeof(uint32_t))
                return;
            msg.MsgType = EN_TSH_FIELD_INFORM_CAMERAS_STATE;
			msg.MsgData = *(uint32_t*)data_temp;
			EnQueue(&MsgQueue,&msg);
        break;
