 ...
 *
 *referenced from  ARCCORE open source
 */
#include "nm.h"
#include "config.h"
#include "stdio.h"
...
//    int i=0;
	...
	CAN_INFO_S tbox_send ={0};

	tbox_send.ulID = nm_blk->nmBaseAddr|nm_blk->nmTxPdu.Source;
	tbox_send.ucLen = 0x08;
	tbox_send.aucData[0] = nm_blk->nmTxPdu.Destination;
	tbox_send.aucData[1] = nm_blk->nmTxPdu.OpCode.b;

	CAN0_Write_nm_Msg(tbox_send);
