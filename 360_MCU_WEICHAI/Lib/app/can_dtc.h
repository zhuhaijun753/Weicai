...
#define  MAIN_PWR_HIGHT_ALARM_VALUE    160u  //16V
#define  MAIN_PWR_HIGHT_ALARM_RECOVER    155u 

#define  MAIN_PWR_LOW_ALARM_VALUE   		 90u //9V
#define  MAIN_PWR_LOW_ALARM_RECOVER   		 95u //9V

#define  MAIN_PWR_TOO_LOW_VALUE   		 65u //9V
#define  MAIN_PWR_LOW_ALARM_TIM        20  //持续2s
